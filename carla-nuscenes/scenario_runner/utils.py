...
def create_directories(self, split):
    ...
    os.makedirs(path / "LIDAR_TOP", exist_ok=True)
    os.makedirs(path / "velodyne", exist_ok=True)
    os.makedirs(path / "calib", exist_ok=True)
    os.makedirs(path / "planes", exist_ok=True)

    os.makedirs(path / "CAM_FRONT", exist_ok=True)
    os.makedirs(path / "CAM_FRONT_LEFT", exist_ok=True)
    os.makedirs(path / "CAM_FRONT_RIGHT", exist_ok=True)
    os.makedirs(path / "CAM_BACK", exist_ok=True)
    os.makedirs(path / "CAM_BACK_LEFT", exist_ok=True)
    os.makedirs(path / "CAM_BACK_RIGHT", exist_ok=True)
