...
from pom import POM
from sample_script import get_points_covered_by_camera_config

def evaluate(map, pom_params, lidar_params, config):
        points = get_points_covered_by_camera_config(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p','--params', type=str, default="multihyper_camera.toml", help="Params")
    parser.add_argument('-c','--configuration', type=str, default="config_camera.toml", help="Configuration")
    ...
    type = ['Camera Placement X']
    pom_list = [('vehicle', pom_car), ('pedestrian', pom_ped), ('bicycle', pom_cyc)]
